class TOEICTest {
  constructor() {
    ...
    this.timer = null;
    this.levelUrlMap = {
      a1: "http://127.0.0.1:8000/api/final-exam/1/",
      a2: "http://127.0.0.1:8000/api/final-exam/2/",
      b1: "http://127.0.0.1:8000/api/final-exam/3/",
  ...
  async handleSubmit(isAutoSubmit = false) {
    ...
    const answers = this.questions
      .map((question) => ({
        ...
        selected_answer:
          $(`input[name="question${question.id}"]:checked`).val() || null,
      }))
